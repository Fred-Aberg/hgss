...
void editor_state_button(void *domain, void *function_data, cursor_t *cursor)
{
	if (!cursor->left_button_pressed)
		return;
	editor_state = (intptr_t)function_data;
}
...
void bind_ui()
{
	...
	editor_cntr = ascui_container(true, PERCENTAGE, 100, VERTICAL, 2,
	...
	main_menu_cntr = ascui_container(true, PERCENTAGE, 100, VERTICAL, 3,
		ascui_container(true, PERCENTAGE, 33, VERTICAL, 1,
			ascui_text(true, STATIC, TILES, 1, strlen(" "), " ", s_3)
		),
		ascui_box(true, STATIC, PERCENTAGE, 33, HORIZONTAL, s_0, 4,
			ascui_button(true, STATIC, TILES, 9, strlen("<#-HGSS EDITOR-#>"), "<#-HGSS EDITOR-#>", s_1, NULL, NULL, NULL),
			ascui_button(true, HOVERABLE, TILES, 5, strlen(">New World"), ">New World", s_0, editor_state_button, (void *)NEW_WORLD, NULL),
			ascui_button(true, HOVERABLE, TILES, 5, strlen(">Load World"), ">Load World", s_0, editor_state_button, (void *)LOAD_WORLD, NULL),
