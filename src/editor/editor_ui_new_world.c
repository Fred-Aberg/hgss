...
container_t *new_world_menu_cntr;

void bind_new_world_menu_ui()
{
	...
	new_world_menu_cntr = ascui_container(true, PERCENTAGE, 100, VERTICAL, 3,
		...
		ascui_box(true, STATIC, PERCENTAGE, 80, HORIZONTAL, s_1, 4,
			ascui_button(true, STATIC, TILES, 9, strlen("<#-NEW WORLD-#>"), "<#-NEW WORLD-#>", s_1, NULL, NULL, NULL),
			ascui_button(true, STATIC, TILES, 3, strlen("<#-LOAD PRE-EXISTING MAP-#>"), "<#-LOAD PRE-EXISTING MAP-#>", s_1, NULL, NULL, NULL),
			ascui_button(true, STATIC, TILES, 3, strlen("<#-CREATE NEW MAP-#>"), "<#-CREATE NEW MAP-#>", s_1, NULL, NULL, NULL),
			ascui_text(true, STATIC, TILES, 1, strlen(" "), " ", s_1)
		),
