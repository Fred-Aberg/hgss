	...
	top_container = ascui_container(true, PERCENTAGE, 100, VERTICAL, 2,
		...
		ascui_container(true, TILES, 1, HORIZONTAL, 2,
			ascui_container(true, TILES, 11, VERTICAL, 3,
				ascui_box(true, TILES, 12, VERTICAL, s_3, 1, 
					end_turn_button = ascui_button(true, TILES, 3, strlen("End Turn"), "End Turn", s_3, end_turn_button_func, NULL, NULL)
				),
				ascui_box(true, PERCENTAGE, 33, VERTICAL, s_3, 1, 
					cell_info_text = ascui_text(true, TILES, 1, 0, NULL, s_3)
				),
				ascui_box(true, TILES, 1, HORIZONTAL, s_3, 4, 
